...
<details><summary>[12] Kodeka[wght].ttf</summary>
<div>
<details>
...
* ⚠️ **WARN** <p>Family metadata at fonts/Kodeka/variable does not have an article.</p>
 [code: lacks-article]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, old-permic, canadian-aboriginal, tai-le, syriac, coptic, todhri, hebrew, duployan, math, tifinagh</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: limbu, armenian, rejang, chakma, khudawadi, telugu, batak, kannada, kayah-li, tibetan, sinhala, dogra, math, tai-le, yi, thai, hanifi-rohingya, lepcha, new-tai-lue, modi, meetei-mayek, osage, grantha, tifinagh, hanunoo, gujarati, kharoshthi, psalter-pahlavi, adlam, buginese, takri, brahmi, manichaean, devanagari, sundanese, mende-kikakui, mongolian, duployan, gurmukhi, myanmar, gunjala-gondi, bassa-vah, khojki, caucasian-albanian, tai-viet, bengali, miao, phags-pa, balinese, bhaiksuki, tirhuta, malayalam, pahawh-hmong, symbols, thaana, coptic, warang-citi, kaithi, saurashtra, masaram-gondi, khmer, tamil, lao, hebrew, elbasan, wancho, tai-tham, javanese, syloti-nagri, ahom, oriya, tagalog, cham, canadian-aboriginal, syriac, marchen, mahajani, mandaic, newa, tagbanwa, zanabazar-square, buhid, soyombo, sharada, old-permic, sogdian, siddham, music, nko</li>
...
<details><summary>[13] Kodeka-Italic[wght].ttf</summary>
<div>
<details>
    <summary>⚠️ <b>WARN</b> Check accent of Lcaron, dcaron, lcaron, tcaron <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#alt-caron">alt_caron</a></summary>
    <div>
...
<li>U+277D DINGBAT NEGATIVE CIRCLED DIGIT EIGHT: try adding symbols</li>
<li>U+277E DINGBAT NEGATIVE CIRCLED DIGIT NINE: try adding symbols</li>
<li>U+3003 DITTO MARK: try adding one of: chinese-simplified, yi, chinese-hongkong, phags-pa, japanese, chinese-traditional</li>
<li>U+301C WAVE DASH: try adding japanese</li>
<li>U+F8FF : not included in any glyphset definition</li>
<li>U+FB01 LATIN SMALL LIGATURE FI: not included in any glyphset definition</li>
<li>U+FB02 LATIN SMALL LIGATURE FL: not included in any glyphset definition</li>
